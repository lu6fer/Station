...
Sketch uses 689642 bytes (52%) of program storage space. Maximum is 1310720 bytes.
Global variables use 38256 bytes (11%) of dynamic memory, leaving 289424 bytes for local variables. Maximum is 327680 bytes.
 */
const char ssid[] PROGMEM = STASSID;
const char password[] PROGMEM = STAPSK;
void setup()
