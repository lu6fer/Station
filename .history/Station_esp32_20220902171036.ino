...
void wifiSetup()
{
  ...
  // u8g2Fonts.setFont(u8g2_font_fub11_tf);
  display.fillRect(16, 16, 380, 120, GxEPD_WHITE);
  display.setFont(u8g2_font_fur30_tf)
  ...
  //   // display.setPartialWindow(16, 16, 380, 130);
  //   /* display.fillRect(16, 16, 380, 130, GxEPD_WHITE);*/
  //   u8g2Fonts.setFont(u8g2_font_fur30_tf);
